...
void main() {
  ...
  group('AppConfig defaults', () {
    test('default model is a stable Gemini 2.5 model', () {
      expect(AppConfig.defaultModelId, equals('gemini-2.5-flash'));

      final defaultModel = AppConfig.getModelById(AppConfig.defaultModelId);
      expect(defaultModel.modelName, equals('gemini-2.5-flash'));
