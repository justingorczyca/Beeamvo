...
class PromptSettings {
  ...
  factory PromptSettings.fromMap(Map<String, dynamic>? map) {
    ...
    return PromptSettings(
      ...
      transcriptionBackend: map['transcriptionBackend'] as String?,
      cloudProvider: map['cloudProvider'] as String?,
      whisperModelId: map['whisperModelId'] as String?,
      whisperLanguage: map['whisperLanguage'] as String?,
      twoPassTranscriptionEnabled: map['twoPassTranscriptionEnabled'] as bool?,
      twoPassTranscriptionModelId:
          map['twoPassTranscriptionModelId'] as String?,
      twoPassRefinementModelId: map['twoPassRefinementModelId'] as String?,
      rephraseLevel: _rephraseLevelFromString(map['rephraseLevel'] as String?),
      thinkingLevel: GeminiThinkingLevelExtension.fromString(
        map['thinkingLevel'] as String?,
      ),
      twoPassRefinementThinkingLevel: GeminiThinkingLevelExtension.fromString(
        map['twoPassRefinementThinkingLevel'] as String?,
      ),
    );
  }
