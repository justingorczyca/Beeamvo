            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    // Update-available badge (only when a newer release is
                    // cached). Rebuilds the instant the background or manual
                    // check discovers an update. Tapping jumps to General,
                    // where the "Check for Updates" action lives.
                    AnimatedBuilder(
                      animation: provider.settingsService,
                      builder: (context, _) {
                        final update = provider.settingsService.availableUpdate;
