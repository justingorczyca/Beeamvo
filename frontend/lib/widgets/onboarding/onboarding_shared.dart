...
// Using the same tokens as settings_shared.dart so onboarding looks unified.

const Color _kYellow = AppTheme.amber;
const Color _kBlack = AppTheme.chromeBlack;
const Color _kSurfaceRaised = AppTheme.surfaceRaised;
const Color _kSurfaceContainer = AppTheme.surfaceContainer;
const Color _kText = AppTheme.textPrimary;
const Color _kTextSub = AppTheme.textSecondary;
const Color _kTextMuted = AppTheme.textTertiary;
const Color _kBorder = AppTheme.border;
const Color _kSuccess = AppTheme.success;
const Color _kError = AppTheme.error;
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: _kYellow.withValues(alpha: 0.22)),
            ),
            child: Center(
              child: Icon(icon, size: iconSize * 0.72, color: _kYellow),
            ),
          ),
        ...
        return Container(
          decoration: BoxDecoration(
            gradient: RadialGradient(
              ...
              radius: 1.2,
              colors: [
                _kYellow.withValues(alpha: 0.04 + 0.02 * t),
                _kBlack.withValues(alpha: 0.0),
              ],
              stops: const [0.0, 0.7],
            ),
          ),
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: [AppTheme.amber, AppTheme.amberDim],
          ),
          borderRadius: BorderRadius.circular(_kRadiusMd),
          boxShadow: [
            BoxShadow(
          ...
          child: Row(
            ...
            children: [
              if (widget.icon != null) ...[
                Icon(widget.icon, size: 18, color: _kBlack),
              ...
              if (widget.isLoading)
                SizedBox(
                  ...
                  child: CircularProgressIndicator(
                    strokeWidth: 2,
                    valueColor: AlwaysStoppedAnimation(_kBlack),
                  ),
                )
              else
                Text(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  color: isCompleted
                      ? _kYellow
                      : isActive
                      ? _kYellow.withValues(alpha: 0.75)
                      : _kSurfaceContainer,
...
class OnboardingGlowCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final accent = accentColor ?? _kYellow;
    return MouseRegion(
      cursor: onTap != null
      ...
      child: AnimatedContainer(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            hintStyle: GoogleFonts.inter(color: _kTextMuted),
