            ...
            return Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: RadialGradient(
                  colors: [
                    AppTheme.amber.withValues(alpha: 0.25 + 0.10 * t),
                    AppTheme.amber.withValues(alpha: 0.05),
                  ],
                ),
                boxShadow: [
                  BoxShadow(
                    color: AppTheme.amber.withValues(alpha: 0.15 + 0.10 * t),
                    blurRadius: 40,
                    spreadRadius: 4,
                  ),
                ],
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: const LinearGradient(
                      colors: [AppTheme.amber, AppTheme.amberLight],
                      begin: Alignment.topLeft,
                      end: Alignment.bottomRight,
                    ),
                    boxShadow: [
                      BoxShadow(
                        color: AppTheme.amber.withValues(alpha: 0.4 + 0.2 * t),
                        blurRadius: 16,
                      ),
                    ],
                  ),
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  color: _downloadingModelId == null
                                      ...
                                      : AppTheme.surfaceContainer.withValues(
                                          alpha: 0.3,
                                        ),
                                  borderRadius: BorderRadius.circular(
                                    AppTheme.radiusSm,
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: isSelected
                            ? AppTheme.amber.withValues(alpha: 0.12)
                            : AppTheme.surfaceContainer.withValues(alpha: 0.4),
              ...
              children: [
                ...
                AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: _twoPassEnabled ? AppTheme.amber : AppTheme.border,
                    ),
                  ),
                  child: AnimatedAlign(
                    duration: const Duration(milliseconds: 200),
                ...
                builder: (context, child) {
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: _isRecording ? AppTheme.amber : AppTheme.border,
                        width: 1.5,
                      ),
        ...
        if (!isReady) ...[
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(_kRadiusMd),
              border: Border.all(
                color: AppTheme.amber.withValues(alpha: 0.30),
              ),
            ),
            child: Column(
              children: [
