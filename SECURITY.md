...
The full security & privacy review is in
[`docs/security-privacy-audit.md`](docs/security-privacy-audit.md), and the
build/signing/packaging review is in
[`docs/build-ci-packaging-audit.md`](docs/build-ci-packaging-audit.md).
